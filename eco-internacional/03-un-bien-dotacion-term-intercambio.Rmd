#Modelo con un solo bien, dotación, gobierno y términos de intercambio
...
$$
\max_{c_s, s \geq t} \{ \sum_{s\geq t} \beta^{s-t}\ln(c_s):  c_s + b_{s+1} = \Omega_s y_s + (1+r_{s-1})b_s, s \geq t\}
$$
